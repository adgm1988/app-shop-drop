...
<div class="main main-raised">
    <div class="container">
        ...
        <div class="section">
            <h2 class="title text-center">Editar esta categoria</h2>
            @if($errors->any())
            ...
            <form method="post" action="{{ url('/admin/categories/'.$category->id) }}" enctype="multipart/form-data">
                ...
                <textarea class="form-control" placeholder="Descripción de categoria" rows="3" name="description">{{ old('description',$category->description) }}</textarea>
                <button type="submit" class="btn btn-primary">Guardar cambios</button>
                <a href="{{ url('admin/categories') }}" class="btn btn-defaut">Cancelar</a>
            </form>
